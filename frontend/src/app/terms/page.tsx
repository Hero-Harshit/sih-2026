        ...
        <div className="flex-1 lg:ml-16 w-full px-4 sm:px-8 lg:px-12 pt-8 pb-20 overflow-y-auto animate-in fade-in duration-300">
          ...
          <div className="w-full max-w-3xl mx-auto mt-16 text-center text-sm text-slate-400 animate-in fade-in duration-1000 delay-500">
            {language === "hi"
              ...
              : language === "ta"
              ? "கடைசி புதுப்பிப்பு: செப்டம்பர் 2026. ஐபி சக்தி சஹாயக்கைப் பயன்படுத்துவதன் மூலம், இந்த விதிமுறைகள் மற்றும் நிபந்தனைகளை நீங்கள் ஒப்புக்கொள்கிறீர்கள்."
              : language === "te"
              ? "చివరి నవీకరణ: సెప్టెంబర్ 2026. ఐపీ శక్తి సహాయక్ ఉపయోగించడం ద్వారా, మీరు ఈ నిబంధనలు మరియు షరతులను అంగీకరిస్తున్నారు."
              : language === "bn"
              ? "সর্বশেষ আপডেট: সেপ্টেম্বর ২০২৬। আইপি শক্তি সহায়ক ব্যবহার করার মাধ্যমে, আপনি এই শর্তাবলী ও নিয়মে সম্মত হচ্ছেন।"
              : language === "kn"
